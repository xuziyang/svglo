...
export const en: Messages = {
  ...
  preview: {
    ...
    cancel: 'Cancel',
    replace: 'Replace',
    replaceTitle: 'Replace with another image (keeps current settings)',
    ...
    paths: 'Paths',
    largeResult:
      'Large SVG — try the Photo preset, raise Filter speckle, or lower Color precision.',
    manyPaths:
      'Many paths — the result may be hard to edit. Try the Photo preset or raise Filter speckle.',
    originalAlt: 'Original',
    vectorAlt: 'Vector result',
    zoom: 'Zoom',
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
